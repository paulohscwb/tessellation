...
<br><a href="https://paulohscwb.github.io/tessellation/strips/">english version</a>
<form style="margin: 0 auto; float:right; text-align:right; width:100%; margin-bottom:15px;">
	<select id="url" onchange="urlHandler(this.value)" style="color:royalblue;">
		...
		<option disabled value="../../strips/pt-br/">Tesselações em tiras</option>
...
<p id="p1"></p>
  <h2 align="center"><img src="../vr/salas/imagens/icone.png" style="margin-bottom:-10px" width="45"> Tesselações em tiras</h2>
...
<br>Este trabalho mostra as tesselações feitas nas faces de poliedros, aproveitando as simetrias retangulares das faces destes sólidos. 
<br>Nesta página, temos algumas obras de tesselações em forma de tiras, inseridas nas faces retangulares dos poliedros de estrelação ao infinito.
...
<iframe width="560" height="315" style="max-width:100%" src="https://www.youtube.com/embed/videoseries?list=PLy0I_lGW8HxXTLTFRb8j0qJKEyB5SMvDQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
<h4>1. Calçada do Rio de Janeiro</h4>
...
<h4>11. Cruz de Menger de Jerusalém</h4>
...
<a href="../vr/Tessellation16.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/13A.png" class="foto" alt="Árvore da vida"></a>
 ...
 <br>
<hr>
<h4>14. Curva entrelaçada</h4>
<a href="../vr/Tessellation13.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/14A.png" class="foto" alt="Curva entrelaçada"></a>
 <br><b>descrição</b>: padrão de curva entrelaçada
 <br><b>tipo de tesselação</b>: retangular
 <br><b>poliedros</b>: grande dodecahemicosacron, grande dodecahemidodecacron, hexahemioctacron, pequeno icosihemidodecacron, tetrahemihexacron, grande dodecahemicosacron estrelado, hexahemioctacron estrelado, tetrahemihexacron estrelado
 <br>
<hr>
<h4>15. Curva entrelaçada</h4>
<a href="../vr/Tessellation14.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/15A.png" class="foto" alt="Curva entrelaçada"></a>
 <br><b>descrição</b>: padrão de curva entrelaçada
 <br><b>tipo de tesselação</b>: retangular
 <br><b>poliedros</b>: grande dodecahemicosacron, grande dodecahemidodecacron, hexahemioctacron, pequeno icosihemidodecacron, tetrahemihexacron, grande dodecahemicosacron estrelado, hexahemioctacron estrelado, tetrahemihexacron estrelado
 <br>
<hr>
<h4>16. Lemniscata</h4>
<a href="../vr/Tessellation15.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/16A.png" class="foto" alt="lemniscata"></a>
 <br><b>descrição</b>: padrão de lemniscata
 <br><b>tipo de tesselação</b>: retangular
 <br><b>poliedros</b>: grande dodecahemicosacron, grande dodecahemidodecacron, hexahemioctacron, pequeno icosihemidodecacron, tetrahemihexacron, grande dodecahemicosacron estrelado, hexahemioctacron estrelado, tetrahemihexacron estrelado
 <br>
<hr>
<h4>17. Curva entrelaçada de três folhas</h4>
<a href="../vr/Tessellation17.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/17A.png" class="foto" alt="Curva entrelaçada de três folhas"></a>
 <br><b>descrição</b>: padrão de curva entrelaçada de três folhas
 <br><b>tipo de tesselação</b>: retangular
 <br><b>poliedros</b>: grande dodecahemicosacron, grande dodecahemidodecacron, hexahemioctacron, pequeno icosihemidodecacron, tetrahemihexacron, grande dodecahemicosacron estrelado, hexahemioctacron estrelado, tetrahemihexacron estrelado
 <br>
<hr>
<h4>18. Trevo de quatro folhas</h4>
<a href="../vr/Tessellation18.htm" target="_blank" title="modelo 3D" class="fotoA"><img src="../ar/18A.png" class="foto" alt="Trevo de quatro folhas"></a>
 <br><b>descrição</b>: padrão de trevo de quatro folhas
 <br><b>tipo de tesselação</b>: retangular
 <br><b>poliedros</b>: grande dodecahemicosacron, grande dodecahemidodecacron, hexahemioctacron, pequeno icosihemidodecacron, tetrahemihexacron, grande dodecahemicosacron estrelado, hexahemioctacron estrelado, tetrahemihexacron estrelado
 <br>
<hr>
...
<p>Siqueira, P.H., "Tessellation in strips: polyhedra tessellation and visualization with Virtual Reality". Disponível em: <https://paulohscwb.github.io/tessellation/strips/pt-br/>, Maio de 2026.</p>
